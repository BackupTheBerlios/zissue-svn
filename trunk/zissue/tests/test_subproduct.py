...
from zissue.zissuetracker.subproduct import SubProduct


class TestSubProductContainer(TestSampleContainer):
...
def test_suite():
    return unittest.TestSuite((
        DocTestSuite('zissue.zissuetracker.subproduct'),
        unittest.makeSuite(TestSubProductContainer),
        ))
