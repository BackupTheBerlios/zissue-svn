...
from zissue.zissuetracker.component import Component


class TestComponentContainer(TestSampleContainer):
...
def test_suite():
    return unittest.TestSuite((
        DocTestSuite('zissue.zissuetracker.component'),
        unittest.makeSuite(TestComponentContainer),
        ))
