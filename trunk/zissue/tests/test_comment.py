...
from zissue.zissuetracker.comment import Comment


class TestCommentContainer(TestSampleContainer):
...
def test_suite():
    return unittest.TestSuite((
        DocTestSuite('zissue.zissuetracker.comment'),
        unittest.makeSuite(TestCommentContainer),
        ))
