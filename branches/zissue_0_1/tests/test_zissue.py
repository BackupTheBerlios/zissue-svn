...
from zissue.zissuetracker.zissuebase import Zissue


class TestZissueContainer(TestSampleContainer):
...
def test_suite():
    return unittest.TestSuite((
        DocTestSuite('zissue.zissuetracker.zissuebase'),
        unittest.makeSuite(TestZissueContainer),
        ))
