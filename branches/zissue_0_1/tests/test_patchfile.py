...
from zissue.zissuetracker.patchfile import PatchFile


class TestPatchFileContainer(TestSampleContainer):
...
def test_suite():
    return unittest.TestSuite((
        DocTestSuite('zissue.zissuetracker.patchfile'),
        unittest.makeSuite(TestPatchFileContainer),
        ))
